...
namespace MyVaccine.WebApi.Migrations
{
    ...
    [Migration("20240806023813_AddRowVersionToAllergies")]
    partial class AddRowVersionToAllergies
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyVaccine.WebApi.Models.Dependent", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DependId"));
            ...
            modelBuilder.Entity("MyVaccine.WebApi.Models.Vaccine", b =>
                {
                    ...
                    b.Property<bool>("RequireBooster")
                        .HasColumnType("bit");
